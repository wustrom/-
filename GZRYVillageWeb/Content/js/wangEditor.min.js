...
function () {
    ...
    function i(o) {
        if (o) {
            ...
            var A = o.nodeType,
            r = [];
            9 === A ? r = [o] : 1 === A ? r = [o] : t(o) ? r = o : "string" == typeof o && (o = o.replace("/\n/mg", "").trim(), r = 0 === o.indexOf("<") ? e(o) : n(o));
            var c = r.length;
            if (!c) return this;
            var a = void 0;
    ...
    function _(e, t) {
        ...
        if (null == n ? i = window.clipboardData && window.clipboardData.getData("text") : (i = n.getData("text/plain"), o = n.getData("text/html")), !o && i && (o = "<p>" + a(i) + "</p>"), o) {
            var A = o.split("</html>");
            return 2 === A.length && (o = A[0]),
            o = o.replace(/<(meta|script|link).+?>/gim, ""),
            o = o.replace(/<!--.*?-->/gm, ""),
            o = t ? o.replace(/\s?(class|style)=('|").+?('|")/gim, "") : o.replace(/\s?class=('|").+?('|")/gim, "")
        }
    }
    function U(e) {
        var t = [];
    ...
    B.prototype = {
        ...
        onClick: function (e) {
            ...
            i = void 0,
            A = void 0;
            if ("P" === n.getNodeName()) return i = n.text(),
            A = o("<blockquote>" + i + "</blockquote>"),
            A.insertAfter(n),
            void n.remove();
                ...
                if (t) {
                    ...
                    if ("CODE" === A && "PRE" === r && n.cmd.queryCommandSupported("insertHTML")) {
                        if (!0 === n._willBreakCode) {
                            var c = o("<p><br></p>");
                            return c.insertAfter(i),
                            n.selection.createRangeByElem(c, !0),
                            n.selection.restoreSelection(),
                            n._willBreakCode = !1,
                        ...
                        n.selection.getRange().startOffset === a && n.cmd.do("insertHTML", "\n");
                        var s = t.html().length;
                        n.selection.getRange().startOffset + 1 === s && (n._willBreakCode = !0),
                        e.preventDefault()
                    }
                }
            }
        ...
        _pasteHandle: function () {
            ...
            function (n) {
                if (!L.isIE()) {
                    ...
                    if (A) {
                        var r = A.getNodeName();
                        if ("CODE" === r || "PRE" === r) return void e.cmd.do("insertHTML", "<p>" + o + "</p>");
                        if (i) try {
    ...
    R.prototype = {
        ...
        do: function (e, t) {
            ...
            if (n.selection.getRange()) {
                ...
                n.selection.saveRange(),
                n.selection.restoreSelection();
                var o = !1;["insertOrderedList", "insertUnorderedList"].indexOf(e) >= 0 && (o = !0),
                n.change && n.change(o)
            }
        },
            ...
            if (e && e.length) {
                ...
                if (w || o || c) {
                    ...
                    function (e) {
                        var t = e.name,
                        n = e.size;
                        if (t && n) return !1 === /\.(jpg|jpeg|png|bmp|gif)$/i.test(t) ? void b.push("【" + t + "】不是图片") : a < n ? void b.push("【" + t + "】大于 " + s + "M") : void v.push(e)
                    ...
                    function (e) {
                        ...
                        C.upload && (C.upload.onprogress = function (e) {
                            ...
                            if (4 === C.readyState) {
                                ...
                                if (e = C.responseText, "object" !== (void 0 === e ? "undefined" : O(e))) try {
                                    e = JSON.parse(e)
                        } catch (i) {
...
(e.data || []).forEach(function (e) {
                        ...
                        f.before && "function" == typeof f.before) {
                            ...
                            if (x && "object" === (void 0 === x ? "undefined" : O(x)) && x.prevent) return void this._alert(x.msg)
                        }
                        return A(p,
                        function (e, t) {
    ...
    H.prototype = {
        ...
        _bindEvent: function () {
            ...
            var o = n.onchange;
            o && "function" == typeof o && (this.change = function (n) {
                var A = this.txt.html();
